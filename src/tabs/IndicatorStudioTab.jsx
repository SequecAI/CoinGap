      ...
      <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-4">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3 space-y-1">
          ...
          <p className="text-[11px] text-slate-600 leading-relaxed">
            과거 5분봉을 순회하며 점수가 임계값을 만족할 때마다 신호로 카운트합니다. <strong className="text-emerald-600 font-bold">저평가 신호</strong>(score ≥ 저평가 임계값)는 이후 3봉(15분) 이내 봉의 <strong>고가</strong>가 신호가 대비 <strong className="text-emerald-600 font-bold">+0.5% 이상</strong>이면 <strong>적중</strong>, <strong className="text-emerald-600 font-bold">+1.5% 이상</strong>이면 <strong>강한 적중</strong>. <strong className="text-red-500 font-bold">고평가 신호</strong>(score ≤ 고평가 임계값)는 이후 3봉의 <strong>저가</strong>가 -0.5%/-1.5% 도달 여부를 같은 룰로 측정합니다. 강한 적중은 적중에 포함됩니다.
          </p>
        </div>
